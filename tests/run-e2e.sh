...
# export CYCLONE_SERVER=${CYCLONE_SERVER:-"http://172.17.0.1:7099"}
# export REGISTRY_LOCATION=${REGISTRY_LOCATION:-"localhost:5000"}
# # Static configs.
...
# export MONGODB_HOST="127.0.0.1:28017"
# export KAFKA_HOST="127.0.0.1:9092"
# export CLAIR_SERVER="127.0.0.1:6060"
...
# export GITLAB_CLIENT=0
# export GITLAB_SECRET=0
