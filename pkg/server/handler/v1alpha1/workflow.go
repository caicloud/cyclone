...
func CreateWorkflow(ctx context.Context) (*v1alpha1.Workflow, error) {
	...
	wc, err := handler.K8sClient.CycloneV1alpha1().Workflows(wf.Namespace).Create(wf)
	if err != nil {
...
func ListWorkflows(ctx context.Context, namespace string) (*v1alpha1.WorkflowList, error) {
	return handler.K8sClient.CycloneV1alpha1().Workflows(namespace).List(metav1.ListOptions{})
}

// GetWorkflow ...
func GetWorkflow(ctx context.Context, name, namespace string) (*v1alpha1.Workflow, error) {
	return handler.K8sClient.CycloneV1alpha1().Workflows(namespace).Get(name, metav1.GetOptions{})
}
...
func UpdateWorkflow(ctx context.Context, name string) (*v1alpha1.Workflow, error) {
	...
	return handler.K8sClient.CycloneV1alpha1().Workflows(wf.Namespace).Update(wf)
}

// DeleteWorkflow ...
func DeleteWorkflow(ctx context.Context, name, namespace string) error {
	return handler.K8sClient.CycloneV1alpha1().Workflows(namespace).Delete(name, nil)
}
