...
func CreateResource(ctx context.Context) (*v1alpha1.Resource, error) {
	...
	return handler.K8sClient.CycloneV1alpha1().Resources(rs.Namespace).Create(rs)
}

// ListResources ...
func ListResources(ctx context.Context, namespace string) (*v1alpha1.ResourceList, error) {
	return handler.K8sClient.CycloneV1alpha1().Resources(namespace).List(metav1.ListOptions{})
}

// GetResource ...
func GetResource(ctx context.Context, name, namespace string) (*v1alpha1.Resource, error) {
	return handler.K8sClient.CycloneV1alpha1().Resources(namespace).Get(name, metav1.GetOptions{})
}
...
func UpdateResource(ctx context.Context, name string) (*v1alpha1.Resource, error) {
	...
	return handler.K8sClient.CycloneV1alpha1().Resources(rs.Namespace).Update(rs)
}

// DeleteResource ...
func DeleteResource(ctx context.Context, name, namespace string) error {
	return handler.K8sClient.CycloneV1alpha1().Resources(namespace).Delete(name, nil)
}
