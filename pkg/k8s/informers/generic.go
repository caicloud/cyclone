...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (informers.GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("cycloneresources"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cyclone().V1alpha1().CycloneResources().Informer()}, nil
