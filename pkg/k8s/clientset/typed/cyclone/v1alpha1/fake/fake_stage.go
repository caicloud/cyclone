...
var stagesResource = schema.GroupVersionResource{Group: "cyclone.caicloud.io", Version: "v1alpha1", Resource: "stages"}

var stagesKind = schema.GroupVersionKind{Group: "cyclone.caicloud.io", Version: "v1alpha1", Kind: "Stage"}
