...
var (
	...
	clientsetInterface             = types.Name{Package: "k8s.io/client-go/kubernetes", Name: "Interface"}
	sharedInformerFactoryInterface = types.Name{Package: "k8s.io/client-go/informers", Name: "SharedInformerFactory"}
	...
	v1GetOptions                   = types.Name{Package: "k8s.io/apimachinery/pkg/apis/meta/v1", Name: "GetOptions"}
